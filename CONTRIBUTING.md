...
[feature-new]: https://github.com/i11n/please/issues/new?template=feature.yaml&title= "Request a new feature in kz.io"
[issues]: https://github.com/i11n/kz-${pkgName}/issues/new?template=issue.yaml&title= "Report an issue in @kz/${pkgName}"
[feature]: https://github.com/i11n/kz-${pkgName}/issues/new?template=feature.md&title= "Request a new feature in @kz/${pkgName}"
[documentation]: https://github.com/i11n/kz-${pkgName}/labels/type%3A%20docs "Documentation issues in @kz/${pkgName}"
[first-issue]: https://github.com/i11n/kz-${pkgName}/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22 "Good first issues in @kz/${pkgName}"